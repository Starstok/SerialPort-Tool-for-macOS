...
//    //发送区显示文字为黑色，大小为13
//    [self.TXDataDisplayTextView.textStorage addAttribute:NSFontAttributeName value:[NSFont fontWithName:@"Andale Mono" size:13] range:NSMakeRange(0, [self.TXDataDisplayTextView string].length)];
